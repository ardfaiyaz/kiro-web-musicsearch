...
export default function FavoriteAlbumsSkeleton() {
  return (
    <div className="space-y-8" aria-busy="true" aria-label="Loading favorite albums">
      {/* Hero Skeleton */}
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <ShimmerSkeleton shape="rectangle" width="120px" height="44px" className="rounded-xl" />
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} className="flex flex-col gap-3 rounded-2xl p-3">
            <ShimmerSkeleton shape="rectangle" height="0" className="aspect-square w-full rounded-xl" />
