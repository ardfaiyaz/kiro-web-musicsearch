...
export type ArtistSortOption = "recent" | "alphabetical" | "genre";

interface ArtistSortingProps {
  value: ArtistSortOption;
  onChange: (sort: ArtistSortOption) => void;
}

const SORT_OPTIONS: { value: ArtistSortOption; label: string }[] = [
  { value: "recent", label: "Recently Added" },
  { value: "alphabetical", label: "Alphabetical" },
  { value: "genre", label: "Genre" },
];

export default function ArtistSorting({ value, onChange }: ArtistSortingProps) {
